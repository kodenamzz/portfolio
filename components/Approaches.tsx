  ...
  return (
    <section className="w-full py-20">
      <h1 className="heading">
        My <span className="text-purpleDark dark:text-purple">Approaches</span>
      </h1>
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          title="Planing & Strategy"
          icon={<ApproachIcon order="Phase 1" />}
        ...
        <Card
          ...
          icon={<ApproachIcon order="Phase 2" />}
        ...
        <Card
          ...
          icon={<ApproachIcon order="Phase 3" />}
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        <div className="text-center group-hover/canvas-card:-translate-y-4 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] group-hover/canvas-card:opacity-0 transition duration-200 mx-auto flex items-center justify-center min-h-24">
          {icon}
        </div>
...
const ApproachIcon = ({ order }: { order: string }) => {
  return (
    <MagicButton title={order} icon={""} containerClasses="!mt-0 p-[2px]" />
  );
};
